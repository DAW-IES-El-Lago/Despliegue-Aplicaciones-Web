...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2024 a las 14:05:12
...
--
ALTER TABLE `deporte`
  MODIFY `idNombre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `deporte_aficionado`
--
ALTER TABLE `deporte_aficionado`
  MODIFY `idAficionado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
